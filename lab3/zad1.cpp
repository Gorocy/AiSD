...
int main() {
    ...
    // Sortuj listę główną wg preferencji dla danego wydziału
//    sortByPreference(mainList, 1); // Przykładowy wydział: 1 - Wydział Iluzji

    // Rozdziel studentów na listy wydziałów na podstawie preferencji
